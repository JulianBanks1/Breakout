...
PowerupManager::PowerupManager(sf::RenderWindow* window, Paddle* paddle, Ball* ball, sf::RenderTexture* renderTex)
    : _window(window), _paddle(paddle), _ball(ball), _renderTex(renderTex)
{
}
...
void PowerupManager::spawnPowerup()
{
    ...
    {
    case 0:
        _powerups.push_back(new PowerupBigPaddle(_window, _paddle, _ball, _renderTex));
        break;
    case 1:
        _powerups.push_back(new PowerupSlowBall(_window, _paddle, _ball, _renderTex));
        break;
    case 2:
        _powerups.push_back(new PowerupFastBall(_window, _paddle, _ball, _renderTex));
        break;
    case 3:
        _powerups.push_back(new PowerupSmallPaddle(_window, _paddle, _ball, _renderTex));
        break;
    case 4:
        _powerups.push_back(new PowerupFireBall(_window, _paddle, _ball, _renderTex));
        break;
    case 5:
       break;
    }
